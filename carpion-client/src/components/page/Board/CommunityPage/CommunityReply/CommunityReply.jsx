...
function CommunityReply({ reviewNo }) {
      ...
      const fetchComments = async () => {
         ...
         try {
            const response = await axios.get(
               `${apiUrl}/reviews/comments?reviewNo=${reviewNo}`,
               accessToken
                  ? {
                       headers: {
   ...
   const handleDelete = async (commentNo) => {
      try {
         await axios.delete(`${apiUrl}/reviews/comments/${commentNo}`, {
            headers: {
               Authorization: `Bearer ${accessToken}`,
            },
         });
      ...
      <div className={crstyles.comment}>
         <div className={crstyles.commentHeader}>
            ...
            <div className={crstyles.rightTop}>
               <span className={crstyles.commentTime}>
                  {comment.createDate}
               </span>
