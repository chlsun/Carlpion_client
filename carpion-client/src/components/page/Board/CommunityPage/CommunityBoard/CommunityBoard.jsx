...
const PostCard = React.memo(
   ({
      ...
      const mainImage =
         fileUrls.length > 0 ? `${apiUrl}/uploads/${fileUrls[0]}` : defaultImg;
               ...
               <div className={cbstyles.ThumbnailWrapper}>
                  ...
                  <div className={cbstyles.TextInfo}>
                     ...
                     <div className={cbstyles.ThumbnailMeta}>
                        <span className={cbstyles.author}>
                           작성자: {nickName}
                        </span>
                        <span className={cbstyles.date}>
                           작성일: {formattedDate}
                        </span>
                        <span className={cbstyles.views}>조회수: {count}</span>
                        <span className={cbstyles.likes}>
                           좋아요: {likeCount}
                        </span>
                     </div>
                  </div>
