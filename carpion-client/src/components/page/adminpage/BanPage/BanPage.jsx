         ...
         <div className="size-full min-h-screen bg-gray-100 flex justify-center select-none">
            <div className="w-7xl my-48 px-8 py-6 bg-white border-2 border-maincolor rounded-4xl flex flex-col gap-4">
               <section className="flex justify-between">
                  <div className="font-maintheme text-2xl text-maincolor">
                     회원 목록
                  </div>
               ...
               <section className="flex justify-between text-center">
                  <div className="flex gap-1">
                     ...
                     <input
                        ...
                        className="px-2 py-1 border-2 border-gray-300 rounded-md font-Pretendard text-lg"
                     />
                     <button
                        type="button"
                        className="px-2 py-1 border-2 border-maincolor rounded-md font-maintheme text-lg text-maincolor active:bg-maincolor active:text-white cursor-pointer"
                     >
                        찾기
                     </button>
                  </div>
                  <div className="flex justify-center gap-1">
                     <div className="px-2 py-1 border-2 border-maincolor rounded-md font-maintheme text-lg text-maincolor active:bg-maincolor active:text-white cursor-pointer">
                        이전
                     </div>
                     <div className="w-10 py-1 border-2 border-maincolor rounded-md font-maintheme text-lg text-maincolor cursor-pointer">
                        1
                     </div>
                     <div className="w-10 py-1 border-2 border-maincolor rounded-md font-maintheme text-lg text-maincolor cursor-pointer">
                        10
